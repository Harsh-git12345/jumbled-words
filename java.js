 ...
 const words = ['dam', 'Don', 'Laptop', 'Science', 'Engineer', 'Webdesiginer', 'Developer', 'Javascript', 'HTML', 'Game','Society','Computer','MrInventer','Text','Incorrect','Fan','Calender','Wall','Window','Door','Sketch','Charger','Jug','Carrot','Tie','Shoes','Shocks'];
